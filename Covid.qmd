...
#### the contries with more than 10000 deaths
...
pie_chart <- ggplot(updated_tibble, aes(x = "", y = percentage, fill = country_region)) +
  ...
  labs(title = "TOP 7 covids deaths")
...
ggplot() +
  ...
  labs(
    title = "Mapping the coronavirus deaths",
    caption = "Updates since "
  ) +
  theme(
